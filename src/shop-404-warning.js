...
class Shop404Warning extends PolymerElement {
  static get template() {
    ...
    <div>
      ...
      <h1 style="font-family: 'B Nazanin', 'Roboto', 'Noto', sans-serif">نگرانیم، صفحه مورد نظر یافت نشد</h1>
    </div>
    <shop-button>
      <a href="/"style="font-family: 'B Nazanin', 'Roboto', 'Noto', sans-serif">رفتن به صفحه اصلی</a>
    </shop-button>
`;
  }
