      ...
      <div class="detail">
        <div class="quantity">
          <shop-select>
            ...
            <select style="font-family: 'B Nazanin'" id="quantitySelect" aria-label="Change quantity" value="[[entry.quantity]]" on-change="_quantityChange">
              <option style="font-family: 'B Nazanin'" value="1">1</option>
