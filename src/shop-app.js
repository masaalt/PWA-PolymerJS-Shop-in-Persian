  ...
  static get template() {
    ...
    <app-header role="navigation" id="header" effects="waterfall" condenses="" reveals="">
      <app-toolbar>
        ...
        <div class="logo1" style="text-align: center; text-decoration:blink"  main-title=""><a href="/" aria-label="GOLNUSH Home">گلنوش</a>
        </div>
    ...
    <iron-pages role="main" selected="[[page]]" attr-for-selected="name" selected-attribute="visible" fallback-selection="404">
      ...
      <shop404--warning name="404"></shop404--warning>
      <site-map name="sitemap"></site-map>
    </iron-pages>

    <footer>
      <a href="at-golnush.web.app">آدرس جهت دریافت حضوری: شیراز</a>
      <br>
      <a href="at-golnush.web.app">توسط موج سان فناور</a>
      <div class="demo-label">فروشیار</div>
    </footer>
...
`;
  ...
  _onChangeSection(event) {
    ...
    if (detail.title) {
      document.title = detail.title + 'صفحه اصلی فروشگاه محصولات گیاهی';
  ...
  _computePluralizedQuantity(quantity) {
    return quantity + ' ' + (quantity === 1 ? 'آیتم' : 'آیتم');
  }
}
